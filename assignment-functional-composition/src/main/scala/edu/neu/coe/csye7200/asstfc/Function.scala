...
object Function {
  ...
  def lift2[T1, T2, R](f: (T1, T2) => R): (Try[T1], Try[T2]) => Try[R] = (t1y, t2y) => map2(t1y, t2y)(f) // TO BE IMPLEMENTED
  ...
  def lift3[T1, T2, T3, R](f: (T1, T2, T3) => R): (Try[T1], Try[T2], Try[T3]) => Try[R] = (t1y, t2y, t3y) => map3(t1y, t2y, t3y)(f) // TO BE IMPLEMENTED
  ...
  (Try[T1], Try[T2], Try[T3], Try[T4], Try[T5], Try[T6], Try[T7]) => Try[R] = (t1y, t2y, t3y, t4y, t5y, t6y, t7y) => map7(t1y, t2y, t3y, t4y, t5y, t6y, t7y)(f) // TO BE IMPLEMENTED
